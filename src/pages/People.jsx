...
const People = () => {
  ...
  // --- Student Data ---
  const phdStudents = [
    { name: 'Aadarsh Singh', image: '/assets/stu_images/phd/Aadarsh Singh.jpg', email: 'phd2201204001@iiti.ac.in' },
    { name: 'Achala Singh', image: '/assets/stu_images/phd/Achala Singh (PhD).jpg', email: 'phd1901204008@iiti.ac.in' },
    { name: 'Akash Paradkar', image: '/assets/stu_images/phd/Akash Paradkar(PhD).jpg', email: 'phd1801104008@iiti.ac.in' },
    { name: 'Akshay', image: '/assets/stu_images/phd/Akshay.jpg', email: 'phd2301204011@iiti.ac.in' },
    { name: 'Alok Sharma', image: '/assets/stu_images/phd/Alok Sharma (PhD).jpg', email: 'phd2001204001@iiti.ac.in' },
    ...
    { name: 'ASTHA SHARMA', image: '/assets/stu_images/phd/ASTHA SHARMA (PhD).jpg', email: 'phd2201204002@iiti.ac.in' },
    { name: 'astha', image: '/assets/stu_images/phd/astha.jpg', email: 'phd2301204008@iiti.ac.in' },
    { name: 'Bodhanam', image: '/assets/stu_images/phd/Bodhanam.jpg', email: 'phd2201204004@iiti.ac.in' },
    { name: 'Deepak Mishra', image: '/assets/stu_images/phd/Deepak Mishra (PhD).jpg', email: 'phd1701104010@iiti.ac.in' },
    { name: 'Gaurav Sharma', image: '/assets/stu_images/phd/Gaurav Sharma(PhD).jpg', email: 'phd1801204002@iiti.ac.in' },
    { name: 'Ghulam Hussain', image: '/assets/stu_images/phd/Ghulam Hussain (PhD).jpg', email: 'phd1701204002@iiti.ac.in' },
    { name: 'Gourav Agrawal', image: '/assets/stu_images/phd/Gourav Agrawal (PhD).jpg', email: 'phd1701104009@iiti.ac.in' },
    { name: 'Gyanesh', image: '/assets/stu_images/phd/Gyanesh.jpg', email: 'phd2101104007@iiti.ac.in' },
    { name: 'Harshvardhan Solanki', image: '/assets/stu_images/phd/Harshvardhan Solanki (PhD).jpg', email: 'phd1901104005@iiti.ac.in' },
    ...
    { name: 'Jatin Garhekar', image: '/assets/stu_images/phd/Jatin Garhekar (PhD).jpg', email: 'phd2201204005@iiti.ac.in' },
    { name: 'Jitendra Mathankar', image: '/assets/stu_images/phd/Jitendra Mathankar (PhD).jpg', email: 'phd1901204003@iiti.ac.in' },
    { name: 'Kajol Kankane', image: '/assets/stu_images/phd/Kajol Kankane (PhD).jpg', email: 'phd1901204007@iiti.ac.in' },
    ...
    { name: 'Kushal Patil', image: '/assets/stu_images/phd/Kushal Patil.jpg', email: 'phd1901104003@iiti.ac.in' },
    { name: 'Mahaveer Singh Dangi ', image: '/assets/stu_images/phd/Mahaveer Singh Dangi (PhD).jpg', email: 'phd1801104009@iiti.ac.in' },
    { name: 'Manish Yadav ', image: '/assets/stu_images/phd/Manish Yadav (PhD).jpg', email: 'phd1901204006@iiti.ac.in' },
    { name: 'Mayank Upadhyay', image: '/assets/stu_images/phd/Mayank Upadhyay.jpg', email: 'phd2201204006@iiti.ac.in' },
    ...
    { name: 'Nikhil Pandey', image: '/assets/stu_images/phd/Nikhil Pandey (PhD).jpg', email: 'phd1901204002@iiti.ac.in' },
    ...
    { name: 'Rohit Vyas', image: '/assets/stu_images/phd/Rohit Vyas(PhD).jpg', email: 'phd1901204005@iiti.ac.in' },
    ...
    { name: 'Saket', image: '/assets/stu_images/phd/SAKET.jpg', email: 'phd2101104004@iiti.ac.in' },
    { name: 'Sanchit', image: '/assets/stu_images/phd/Sanchit.jpg', email: 'phd2301104002@iiti.ac.in' },
    { name: 'Sarvjeet Singh', image: '/assets/stu_images/phd/Sarvjeet Singh (PhD).jpg', email: 'phd1701204005@iiti.ac.in' },
    { name: 'Sayak Chakravorty', image: '/assets/stu_images/phd/Sayak Chakravorty (PhD).jpg', email: 'phd2001104005@iiti.ac.in' },
    { name: 'Shivam', image: '/assets/stu_images/phd/Shivam.jpg', email: 'phd2301204004@iiti.ac.in' },
    { name: 'Shivukumar', image: '/assets/stu_images/phd/Shivukumar.jpg', email: 'phd2101204007@iiti.ac.in' },
    { name: 'Shubham More', image: '/assets/stu_images/phd/Shubham More (PhD).jpg', email: 'phd2001104006@iiti.ac.in' },
    { name: 'Shuddhashil', image: '/assets/stu_images/phd/Shuddhashil.jpg', email: 'phd2101204008@iiti.ac.in' },
    ...
    { name: 'Sugato Panda', image: '/assets/stu_images/phd/Sugato Panda (PhD).jpg', email: 'phd2201104001@iiti.ac.in' },
    { name: 'Sumedh Kishor Limaye', image: '/assets/stu_images/phd/Sumedh Kishor Limaye (PhD).jpg', email: 'phd1701104007@iiti.ac.in' },
    { name: 'Utkarsh Baranwal', image: '/assets/stu_images/phd/Utkarsh Baranwal (PhD).jpg', email: 'phd2001204003@iiti.ac.in' },
    { name: 'Veena N Bhajantri', image: '/assets/stu_images/phd/Veena N Bhajantri (PhD).jpg', email: 'phd1901104004@iiti.ac.in' },
    ...
    { name: 'Vikas Rawat', image: '/assets/stu_images/phd/Vikas Rawat(PhD).jpg', email: 'phd2001104001@iiti.ac.in' },
    { name: 'Vikas Sudam Gore', image: '/assets/stu_images/phd/Vikas Sudam Gore (PhD).jpg', email: 'phd1801204003@iiti.ac.in' },
    { name: 'Vikas', image: '/assets/stu_images/phd/Vikas.jpg', email: 'phd2201104003@iiti.ac.in' },
    { name: 'VINAY SHARMA', image: '/assets/stu_images/phd/VINAY SHARMA (PhD).jpg', email: 'phd2201204008@iiti.ac.in' },
