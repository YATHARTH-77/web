...
const People = () => {
  ...
  // --- Student Data ---
  const phdStudents = [
    { name: 'Aadarsh Singh', image: '/assets/stu_images/phd/Aadarsh Singh.jpg' },
    { name: 'Achala Singh', image: '/assets/stu_images/phd/Achala Singh (PhD).jpg' },
    { name: 'Akash Paradkar', image: '/assets/stu_images/phd/Akash Paradkar(PhD).jpg' },
    { name: 'Akshay', image: '/assets/stu_images/phd/Akshay.jpg' },
    { name: 'Alok Sharma', image: '/assets/stu_images/phd/Alok Sharma (PhD).jpg' },
    { name: 'Anshul', image: '/assets/stu_images/phd/Anshul.jpg' },
    { name: 'Arpita', image: '/assets/stu_images/phd/Arpita.jpg' },
    { name: 'ASTHA SHARMA', image: '/assets/stu_images/phd/ASTHA SHARMA (PhD).jpg' },
    { name: 'astha', image: '/assets/stu_images/phd/astha.jpg' },
    { name: 'Bodhanam', image: '/assets/stu_images/phd/Bodhanam.jpg' },
    { name: 'Deepak Mishra', image: '/assets/stu_images/phd/Deepak Mishra (PhD).jpg' },
    { name: 'Gaurav Sharma', image: '/assets/stu_images/phd/Gaurav Sharma(PhD).jpg' },
    { name: 'Ghulam Hussain', image: '/assets/stu_images/phd/Ghulam Hussain (PhD).jpg' },
    { name: 'Gourav Agrawal', image: '/assets/stu_images/phd/Gourav Agrawal (PhD).jpg' },
    { name: 'Gyanesh', image: '/assets/stu_images/phd/Gyanesh.jpg' },
    { name: 'Harshvardhan Solanki', image: '/assets/stu_images/phd/Harshvardhan Solanki (PhD).jpg' },
    { name: 'Himanshu', image: '/assets/stu_images/phd/Himanshu.jpg' },
    { name: 'Hussain', image: '/assets/stu_images/phd/Hussain.jpg' },
    { name: 'Jatin Garhekar', image: '/assets/stu_images/phd/Jatin Garhekar (PhD).jpg' },
    { name: 'Jitendra Mathankar', image: '/assets/stu_images/phd/Jitendra Mathankar (PhD).jpg' },
    { name: 'Kajol Kankane', image: '/assets/stu_images/phd/Kajol Kankane (PhD).jpg' },
    { name: 'Karnati', image: '/assets/stu_images/phd/Karnati.jpg' },
    { name: 'Kuldeep', image: '/assets/stu_images/phd/Kuldeep.jpg' },
    { name: 'Kunal', image: '/assets/stu_images/phd/Kunal.jpg' },
    { name: 'Kushal Patil', image: '/assets/stu_images/phd/Kushal Patil.jpg' },
    { name: 'Mahaveer Singh Dangi ', image: '/assets/stu_images/phd/Mahaveer Singh Dangi (PhD).jpg' },
    { name: 'Manish Yadav ', image: '/assets/stu_images/phd/Manish Yadav (PhD).jpg' },
    { name: 'Mayank Upadhyay', image: '/assets/stu_images/phd/Mayank Upadhyay.jpg' },
    { name: 'Meghna', image: '/assets/stu_images/phd/Meghna.jpg' },
    { name: 'Minu', image: '/assets/stu_images/phd/Minu.jpg' },
    { name: 'Mohd', image: '/assets/stu_images/phd/Mohd.jpg' },
    { name: 'Moirangthem', image: '/assets/stu_images/phd/Moirangthem.jpg' },
    { name: 'KMonika', image: '/assets/stu_images/phd/Monika.jpg' },
    { name: 'MUKUL', image: '/assets/stu_images/phd/MUKUL.jpg' },
    { name: 'Naveen Kumar', image: '/assets/stu_images/phd/Naveen Kumar (PhD).jpg' },
    { name: 'Nikhil Pandey', image: '/assets/stu_images/phd/Nikhil Pandey (PhD).jpg' },
    { name: 'Nikhil', image: '/assets/stu_images/phd/Nikhil.jpg' },
    { name: 'Nitin', image: '/assets/stu_images/phd/Nitin.jpg' },
    { name: 'Parul', image: '/assets/stu_images/phd/Parul.jpg' },
    { name: 'Revanth', image: '/assets/stu_images/phd/Revanth.jpg' },
    { name: 'Rohit Vyas', image: '/assets/stu_images/phd/Rohit Vyas(PhD).jpg' },
    { name: 'Rosa', image: '/assets/stu_images/phd/Rosa.jpg' },
    { name: 'Sachin', image: '/assets/stu_images/phd/Sachin.jpg' },
    { name: 'Saket', image: '/assets/stu_images/phd/SAKET.jpg' },
    { name: 'Sanchit', image: '/assets/stu_images/phd/Sanchit.jpg' },
    { name: 'Sarvjeet Singh', image: '/assets/stu_images/phd/Sarvjeet Singh (PhD).jpg' },
    { name: 'Sayak Chakravorty', image: '/assets/stu_images/phd/Sayak Chakravorty (PhD).jpg' },
    { name: 'Shivam', image: '/assets/stu_images/phd/Shivam.jpg' },
    { name: 'Shivukumar', image: '/assets/stu_images/phd/Shivukumar.jpg' },
    { name: 'Shubham More', image: '/assets/stu_images/phd/Shubham More (PhD).jpg' },
    { name: 'Shuddhashil', image: '/assets/stu_images/phd/Shuddhashil.jpg' },
    { name: 'Smriti', image: '/assets/stu_images/phd/Smriti.jpg' },
    { name: 'Srinidhi', image: '/assets/stu_images/phd/Srinidhi.jpg' },
    { name: 'Sugato Panda', image: '/assets/stu_images/phd/Sugato Panda (PhD).jpg' },
    { name: 'Sumedh Kishor Limaye', image: '/assets/stu_images/phd/Sumedh Kishor Limaye (PhD).jpg' },
    { name: 'Utkarsh Baranwal', image: '/assets/stu_images/phd/Utkarsh Baranwal (PhD).jpg' },
    { name: 'Veena N Bhajantri', image: '/assets/stu_images/phd/Veena N Bhajantri (PhD).jpg' },
    { name: 'Venkatesh', image: '/assets/stu_images/phd/Venkatesh.jpg' },
    { name: 'Vijay', image: '/assets/stu_images/phd/Vijay.jpg' },
    { name: 'Vikas Rawat', image: '/assets/stu_images/phd/Vikas Rawat(PhD).jpg' },
    { name: 'Vikas Sudam Gore', image: '/assets/stu_images/phd/Vikas Sudam Gore (PhD).jpg' },
    { name: 'Vikas', image: '/assets/stu_images/phd/Vikas.jpg' },
    { name: 'VINAY SHARMA', image: '/assets/stu_images/phd/VINAY SHARMA (PhD).jpg' },
